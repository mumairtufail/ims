...
<div class="container-fluid">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h4 class="text-default-900 text-2xl font-medium mb-2">Add New Product</h4>
                ...
                <form action="{{ route('products.store') }}" method="POST">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="brand" name="brand" class="form-input" placeholder="Enter brand name" required>
                        </div>

                        <div class="mb-5">
                            <label for="price" class="text-default-800 text-sm font-medium inline-block mb-2">Price</label>
                            <div class="relative">
                                <input type="number" id="price" name="price" class="form-input px-8" placeholder="0.00" step="0.01" min="0" required>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                <input type="number" id="cost_price" name="cost_price" class="form-input px-8" placeholder="0.00" step="0.01" min="0">
                                <div class="absolute inset-y-0 start-4 flex items-center pointer-events-none z-20">
                                    <span class="text-default-500">$</span>
                                </div>
                                <div class="absolute inset-y-0 end-4 flex items-center pointer-events-none z-20">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" id="stock_quantity" name="stock_quantity" class="form-input" placeholder="0" min="0" required>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="dimensions" name="dimensions" class="form-input" placeholder="e.g., 10 x 5 x 2 cm">
                        </div>
