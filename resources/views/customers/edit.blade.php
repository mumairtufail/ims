...
<div class="container-fluid">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h4 class="text-default-900 text-2xl font-medium mb-2">Edit Customer</h4>
                ...
                <form action="{{ route('customers.update', $customer['id']) }}" method="POST">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="name" name="name" class="form-input" placeholder="Enter customer full name" value="{{ $customer['name'] }}" required>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="customer_id" name="customer_id" placeholder="Customer ID" class="form-input rounded-s-none" value="{{ $customer['customer_id'] }}" required />
                            </div>
                        </div>

                        <div class="mb-5">
                            <label for="email" class="text-default-800 text-sm font-medium inline-block mb-2">Email Address</label>
                            <input type="email" id="email" name="email" class="form-input" placeholder="Enter email address" value="{{ $customer['email'] }}" required>
                        </div>

                        <div class="mb-5">
                            <label for="phone" class="text-default-800 text-sm font-medium inline-block mb-2">Phone Number</label>
                            <input type="tel" id="phone" name="phone" class="form-input" placeholder="Enter phone number" value="{{ $customer['phone'] }}" required>
                        </div>

                        <div class="mb-5">
                            <label for="company" class="text-default-800 text-sm font-medium inline-block mb-2">Company</label>
                            <input type="text" id="company" name="company" class="form-input" placeholder="Enter company name" value="{{ $customer['company'] ?? '' }}">
                        </div>

                        <div class="mb-5">
                            <label for="tax_id" class="text-default-800 text-sm font-medium inline-block mb-2">Tax ID</label>
                            <input type="text" id="tax_id" name="tax_id" class="form-input" placeholder="Enter tax identification number" value="{{ $customer['tax_id'] ?? '' }}">
                        </div>

                        <div class="mb-5">
                            <label for="address" class="text-default-800 text-sm font-medium inline-block mb-2">Street Address</label>
                            <input type="text" id="address" name="address" class="form-input" placeholder="Enter street address" value="{{ $customer['address'] }}" required>
                        </div>

                        <div class="mb-5">
                            <label for="city" class="text-default-800 text-sm font-medium inline-block mb-2">City</label>
                            <input type="text" id="city" name="city" class="form-input" placeholder="Enter city" value="{{ $customer['city'] }}" required>
                        </div>

                        <div class="mb-5">
                            <label for="state" class="text-default-800 text-sm font-medium inline-block mb-2">State/Province</label>
                            <input type="text" id="state" name="state" class="form-input" placeholder="Enter state or province" value="{{ $customer['state'] ?? '' }}">
                        </div>

                        <div class="mb-5">
                            <label for="postal_code" class="text-default-800 text-sm font-medium inline-block mb-2">Postal Code</label>
                            <input type="text" id="postal_code" name="postal_code" class="form-input" placeholder="Enter postal code" value="{{ $customer['postal_code'] ?? '' }}">
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <select id="customer_group" name="customer_group" class="form-input">
                                <option value="Regular" {{ $customer['customer_group'] == 'Regular' ? 'selected' : '' }}>Regular</option>
                                ...
                                <option value="Retail" {{ $customer['customer_group'] == 'Retail' ? 'selected' : '' }}>Retail</option>
                            </select>
                        </div>

                        <div class="mb-5 lg:col-span-2">
                            <label for="notes" class="text-default-800 text-sm font-medium inline-block mb-2">Notes</label>
                            <textarea id="notes" name="notes" rows="4" class="form-input" placeholder="Enter any additional notes about the customer...">{{ $customer['notes'] ?? '' }}</textarea>
                        </div>
